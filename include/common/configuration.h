...
#define FALLOFF_CURVE 3.0
#define FALLOFF_SCALE 2.2

#define PERLIN_LACUNARITY 2.5
#define PERLIN_OCTAVES 5.0
#define PERLIN_OFFSET_X 0.0
#define PERLIN_OFFSET_Y 0.0
#define PERLIN_PERSISTANCE 0.6
#define PERLIN_SCALE 100.0
...
#define KEY_ZOOM_IN SDL_SCANCODE_EQUALS
#define KEY_ZOOM_OUT SDL_SCANCODE_MINUS
